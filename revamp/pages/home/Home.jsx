...
function Home() {
  ...
  return (
    <div className="home">
      ...
      <Hero />
      <main className="main">
        <PageSection  id="bio" space="true" name="About Me" videos={[QuadVideo, NabelyVideo, WoahCodesVideo]} titles={["Quad Consultation", "Nabely App", "woahCodes v1"]} descriptions={["A Web Consulting Startup I Co-Founded", "An Event-Finding App I Worked On", "The First Version Of This Site"]} links={["https://quadconsultation.com", "https://nabely.com", "https://woahcodes.com"]}>
          <LineSlide>
